...
import { Categories, SortPopup, CoctailBlock, LoadingBlock } from '../components';
import Api from '../api';

export default function Home() {
	const [coctails, setCoctails] = React.useState([]);
	...
	return (
		<div className="container">
			...
			<div className="content__items">
				{coctails.length > 0
					? coctails.map((coctail) => <CoctailBlock key={coctail.idDrink} {...coctail} />)
					: Array(12)
							.fill(0)
